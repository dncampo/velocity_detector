...
calibrate = True           # Create a speed_calibrate.jpg file with markers to calculate a px to FT conversion
...
x_diff_max = 175       # max px away for last motion event x pos
y_upper = 200          # Exclude motion events above this point to top of image.
y_lower = 500          # Exclude motion events below this point to bottom of image.
...
CAMERA_WIDTH = 1280     # Set the image stream width for opencv motion scanning default is 320
CAMERA_HEIGHT = 720    # Set the image stream height for opencv motion scanning  default is 240
