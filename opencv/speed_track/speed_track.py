...
def speed_camera():
    ...
    #cap = cv2.VideoCapture('/home/chinomng/downloads/opencv_tutorial/vehicle_detection_haarcascades/dataset/video1.avi')
    #cap = cv2.VideoCapture('/home/chinomng/downloads/opencv_tutorial/david_videos/obliquo.mp4')
    cap = cv2.VideoCapture('/home/chinomng/downloads/opencv_tutorial/david_videos/perpendicular.mp4')
    while True:
    ...
    #for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        if first_image:
            ...
            #print cv2.findContours( thresholdimage,cv2.RETR_EXTERNAL,cv2.CHAIN_APPROX_SIMPLE )
            ...
            if motion_found:
                if cy > y_upper and cy < y_lower:      # movement is within valid y range
                    ...
                    if gui_window_on:
                        ...
                        if ave_speed > 0:
                            #speed_text = str('%5.1f'  % ave_speed )
                            cv2.putText( image2, speed_text, (cx, cy), cv2.FONT_HERSHEY_SIMPLEX, .5, (255,255,0), 1)
                        cv2.putText( image2, speed_text, (1000, 700), cv2.FONT_HERSHEY_SIMPLEX, .5, (255,255,0), 1)
            ...
            if gui_window_on:
                ...
                for i in range ( 10, CAMERA_WIDTH - 9, 10 ):
                    cv2.line( image2,( i ,y_upper - 5 ),( i, y_lower ),(255,0,0), 1 )
                ...
                cv2.imshow('Movement Status', differenceimage)
